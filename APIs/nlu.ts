...
const VALID_FIELDS = ['destination', 'duration', 'numOfTravelers', 'budget', 'pace', 'transportMode', 'arrivalPoint', 'departurePoint', 'startDate', 'yesno', 'dayNumber', 'targetSpotHint', 'replacementCategory'];
